...
const APP_ID = "vpaas-magic-cookie-3b276ad7597c4ce5943f36eb58059556";
                ...
                const init = async () => {
                                if (!window.JitsiMeetExternalAPI) {
                                                  await new Promise((res, rej) => {
                                                                      ...
                                                                      s.src = "https://" + JITSI_DOMAIN + "/" + APP_ID + "/external_api.js";
                                ...
                                const api = new window.JitsiMeetExternalAPI(JITSI_DOMAIN, {
                                                  ...
                                                  interfaceConfigOverwrite: {
                                                                      TOOLBAR_BUTTONS: ["microphone","camera","desktop","fullscreen","hangup","chat","settings","raisehand","videoquality","tileview"],
